...
try {
    $db = thread_db();
    $threads = thread_fetch_all($db, 'Active', $search);
...
<head>
    ...
    <title>Active Threads | Lissential Manila</title>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-options-wrapper">
            ...
            <div class="sidebar-options">
                ...
                <a href="official-active-threads.php" class="is-active">Active</a>
    ...
    <main class="threads-page">
        <section class="threads-hero">
            <div>
                ...
                <p>Ongoing incidents currently being tracked. Click any thread to edit it.</p>
            </div>
        ...
        <nav class="thread-tabs" aria-label="Thread status filters">
            ...
            <a class="is-active" href="official-active-threads.php">Active</a>
        ...
        <?php elseif ($threads === []): ?>
            <section class="thread-state">
                ...
                <h2>No active threads found</h2>
                <p><?= $search !== '' ? 'Try another search term or clear the search box.' : 'Active threads will appear here once officials open them.'; ?></p>
                <?php if ($search !== ''): ?><a href="official-active-threads.php">Clear search</a><?php endif; ?>
            </section>
        <?php else: ?>
            <section class="thread-grid" aria-label="Active Threads results">
