...
try {
    $db = thread_db();
    $threads = thread_fetch_all($db, 'Resolved', $search);
...
<head>
    ...
    <title>Resolved Threads | Lissential Manila</title>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-options-wrapper">
            ...
            <div class="sidebar-options">
                ...
                <a href="official-resolved-threads.php" class="is-active">Resolved</a>
    ...
    <main class="threads-page">
        <section class="threads-hero">
            <div>
                ...
                <p>Incidents that have been cleared. Click any thread to edit or re-open it.</p>
            </div>
        ...
        <nav class="thread-tabs" aria-label="Thread status filters">
            <a class="" href="official-threads.php">All</a>
            <a class="" href="official-active-threads.php">Active</a>
            <a class="is-active" href="official-resolved-threads.php">Resolved</a>
        ...
        <?php elseif ($threads === []): ?>
            <section class="thread-state">
                ...
                <h2>No resolved threads found</h2>
                <p><?= $search !== '' ? 'Try another search term or clear the search box.' : 'Resolved threads will appear here once officials close them out.'; ?></p>
                <?php if ($search !== ''): ?><a href="official-resolved-threads.php">Clear search</a><?php endif; ?>
            </section>
        <?php else: ?>
            <section class="thread-grid" aria-label="Resolved Threads results">
