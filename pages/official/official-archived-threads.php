...
// Only Officials and Admins can review archived threads
...
<head>
    ...
    <title>Archived Threads | Lissential Manila</title>
    ...
    <main class="threads-page">
        ...
        <?php elseif ($threads === []): ?>
            <section class="thread-state">
                ...
                <h2>No archived threads found</h2>
                <p><?= $search !== '' ? 'Try another search term or clear the search box.' : 'Threads land here once an official archives them from Edit Thread.'; ?></p>
                <?php if ($search !== ''): ?><a href="official-archived-threads.php">Clear search</a><?php endif; ?>
            </section>
        <?php else: ?>
            <section class="thread-grid" aria-label="Archived thread results">
