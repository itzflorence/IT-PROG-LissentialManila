...
(1, '+639301239988', 'mgatmaitan@lissentialmanila.ph', 'Max', 'Gatmaitan', 'SysAdmin_Max', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Admin', NULL, 10),
(2, '+639201112233', 'rmendoza@marikina.gov.ph', 'Rosario', 'Mendoza', 'LGU_Marikina_09', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Official', 167, 167),
...
(4, '+639189876543', 'mdelossantos@gmail.com', 'Michael', 'delos Santos', 'MichaelJackson', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 186),
(5, '+639192223333', 'commuter.manila@gmail.com', 'Maria', 'Santos', 'ManilaCommuter', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 106),
(6, '+639215556666', 'nightowl@yahoo.com', 'Kevin', 'Reyes', 'NightOwl_Driver', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 56),
...
(8, '+639184445566', 'lfernandez@pasig.gov.ph', 'Liza', 'Fernandez', 'LGU_Pasig_Ortigas', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Official', 106, 106),
(9, '+639225556677', 'carlo.villa@gmail.com', 'Carlo', 'Villanueva', 'CarloV_Manila', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 10),
(10, '+639296667788', 'bianca.ramos@gmail.com', 'Bianca', 'Ramos', 'BiancaR_Marikina', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 167),
(11, '+639177778899', 'joshuatan@gmail.com', 'Joshua', 'Tan', 'JoshTan_Muntinlupa', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 186),
(12, '+639988889900', 'erica.ocampo@gmail.com', 'Erica', 'Ocampo', 'EricaO_QC', '$2y$10$tSGSizISOsH1NqWhYZT24OBF0CUCMmCDAPRinIg8ajE94YvmGMuzW', 'Student', NULL, 56);
...
(2, 'SLEX Southbound Traffic Congestion', 186, 2, 2, 'Active', 'Stalled vehicle causing major back-ups near Alabang exit.', '2026-07-08 09:30:00', '2026-07-11 17:30:00'),
(3, 'Ortigas Ave Eastbound Multi-Vehicle Collision', 106, 1, 2, 'Active', 'Three-car collision near Meralco Ave intersection.', '2026-07-20 07:45:00', '2026-07-23 08:07:00'),
(4, 'Katipunan Ave Emergency Road Repair', 56, 4, 2, 'Active', 'DPWH re-blocking overnight near Ateneo Gate 3.', '2026-07-20 22:15:00', '2026-07-23 08:11:00'),
(5, 'Marikina Riverbanks Road Construction Delays', 167, 5, 2, 'Active', 'Ongoing riverbank reinforcement project narrowing the road to a single lane.', '2026-07-22 08:00:00', '2026-07-26 03:31:00'),
(6, 'Quiapo Stalled Delivery Truck Blocking Lane', 10, 6, 1, 'Active', 'A delivery truck broke down on the outer lane causing a single-lane bottleneck.', '2026-07-23 16:20:00', '2026-07-25 18:27:00'),
...
(8, 'Broken Traffic Light at Ortigas-Meralco Junction', 106, 7, 8, 'Active', 'Traffic signal malfunctioning during rush hour, causing congestion at the intersection.', '2026-07-25 17:10:00', '2026-07-28 12:11:00');
...
(8, 6, 2, 186, 2, 'Slow-moving traffic along Alabang, Muntinlupa (SLEX)', 'Vehicles are moving at a crawl along Alabang, Muntinlupa (SLEX). No visible incident yet, might just be volume from the holiday rush.', 4, 3, 8, 'Resolved', 'Issue has been addressed and area is now clear.', 8, '2026-07-09 00:39:00', '2026-07-08 20:43:00'),
(9, 12, 2, 186, 2, 'Backed-up intersection at Alabang, Muntinlupa (SLEX)', 'The intersection at Alabang, Muntinlupa (SLEX) is backed up in all directions, enforcers are on scene trying to manually direct flow.', 9, 4, 5, 'Rejected', 'Insufficient evidence / duplicate report.', 8, '2026-07-10 01:39:00', '2026-07-09 22:41:00'),
(10, 9, 2, 186, 2, 'Backed-up intersection at Alabang, Muntinlupa (SLEX)', 'The intersection at Alabang, Muntinlupa (SLEX) is backed up in all directions, enforcers are on scene trying to manually direct flow.', 1, 4, 1, 'Verified', 'Confirmed by field officer.', 8, '2026-07-11 18:41:00', '2026-07-11 17:30:00'),
(11, 12, 2, 186, 2, 'Slow-moving traffic along Alabang, Muntinlupa (SLEX)', 'Vehicles are moving at a crawl along Alabang, Muntinlupa (SLEX). No visible incident yet, might just be volume from the holiday rush.', 4, 4, 8, 'Resolved', 'Issue has been addressed and area is now clear.', 8, '2026-07-11 13:39:00', '2026-07-11 13:22:00'),
(12, 9, 3, 106, 1, 'Motorcycle down near Ortigas Avenue, Pasig', 'A rider lost control and skidded near Ortigas Avenue, Pasig. Bystanders helped move the motorcycle to the shoulder; traffic is moving slowly past the scene.', 9, 4, 4, 'Verified', 'Confirmed by field officer.', 8, '2026-07-21 05:53:00', '2026-07-21 04:57:00'),
(13, 5, 3, 106, 1, 'Rear-end collision along Ortigas Avenue, Pasig', 'Sudden braking caused a rear-end collision along Ortigas Avenue, Pasig during rush hour. Minor damage but drivers are blocking the outer lane while exchanging information.', 3, 4, 11, 'Resolved', 'Issue has been addressed and area is now clear.', 8, '2026-07-23 10:10:00', '2026-07-23 08:07:00'),
(14, 6, 3, 106, 1, 'Motorcycle down near Ortigas Avenue, Pasig', 'A rider lost control and skidded near Ortigas Avenue, Pasig. Bystanders helped move the motorcycle to the shoulder; traffic is moving slowly past the scene.', 8, 2, 5, 'Pending', NULL, NULL, NULL, '2026-07-20 09:03:00'),
(15, 6, 3, 106, 1, 'Delivery van collides with barrier near Ortigas Avenue, Pasig', 'A delivery van clipped a concrete barrier near Ortigas Avenue, Pasig, spilling some cargo onto the road. Cleanup crew has been called.', 6, 4, 0, 'Pending', NULL, NULL, NULL, '2026-07-22 15:39:00'),
(16, 12, 4, 56, 4, 'Debris blocking road at Katipunan Avenue, Quezon City', 'Construction debris has spilled onto the road at Katipunan Avenue, Quezon City, forcing vehicles to merge into a single lane.', 8, 2, 3, 'Pending', NULL, NULL, NULL, '2026-07-23 08:11:00'),
(17, 11, 4, 56, 4, 'Lane closed due to fallen tree near Katipunan Avenue, Quezon City', 'A fallen tree branch is blocking the outer lane near Katipunan Avenue, Quezon City after strong winds. Barangay crew has been notified.', 3, 3, 2, 'Verified', 'Confirmed by field officer.', 2, '2026-07-21 22:57:00', '2026-07-21 21:03:00'),
(18, 3, 4, 56, 4, 'Road partially blocked near Katipunan Avenue, Quezon City', 'Utility crews have partially blocked the road near Katipunan Avenue, Quezon City for emergency repairs, causing a slow single-file merge.', 1, 4, 3, 'Pending', NULL, NULL, NULL, '2026-07-21 06:23:00'),
(19, 6, 5, 167, 5, 'Ongoing construction narrows road at Marikina City', 'Construction work near Marikina City has narrowed the road to one lane. Expect delays especially during peak hours.', 4, 4, 5, 'Pending', NULL, NULL, NULL, '2026-07-25 20:53:00'),
(20, 12, 5, 167, 5, 'Ongoing construction narrows road at Marikina City', 'Construction work near Marikina City has narrowed the road to one lane. Expect delays especially during peak hours.', 2, 2, 2, 'Verified', 'Confirmed by field officer.', 2, '2026-07-22 20:44:00', '2026-07-22 18:20:00'),
(21, 9, 5, 167, 5, 'Ongoing construction narrows road at Marikina City', 'Construction work near Marikina City has narrowed the road to one lane. Expect delays especially during peak hours.', 4, 2, 8, 'Resolved', 'Issue has been addressed and area is now clear.', 2, '2026-07-26 05:02:00', '2026-07-26 03:31:00'),
(22, 9, 5, 167, 5, 'Utility trenching along Marikina City', 'Utility trenching work is ongoing along Marikina City, reducing the road to a single passable lane.', 5, 2, 0, 'Rejected', 'Insufficient evidence / duplicate report.', 2, '2026-07-23 22:28:00', '2026-07-23 18:37:00'),
(23, 11, 6, 10, 6, 'Stalled bus blocking lane at Quiapo, Manila', 'A public bus has stalled at Quiapo, Manila, blocking the rightmost lane. Passengers have already disembarked.', 2, 2, 5, 'Pending', NULL, NULL, NULL, '2026-07-24 07:56:00'),
(24, 3, 6, 10, 6, 'Broken-down truck at Quiapo, Manila', 'A cargo truck broke down at Quiapo, Manila and is waiting for a tow. Traffic enforcers are directing vehicles around it.', 2, 3, 6, 'Resolved', 'Issue has been addressed and area is now clear.', 1, '2026-07-25 22:05:00', '2026-07-25 18:27:00'),
(25, 5, 6, 10, 6, 'Vehicle out of gas along Quiapo, Manila', 'A car ran out of fuel along Quiapo, Manila, blocking part of the lane until it can be pushed to the shoulder.', 3, 3, 2, 'Pending', NULL, NULL, NULL, '2026-07-23 20:03:00'),
(26, 6, 6, 10, 6, 'Overheated car stuck near Quiapo, Manila', 'A private vehicle overheated and stopped near Quiapo, Manila. Hazard lights are on but it''s still causing a slowdown.', 0, 3, 15, 'Resolved', 'Issue has been addressed and area is now clear.', 1, '2026-07-23 21:50:00', '2026-07-23 19:53:00'),
...
(31, 12, 8, 106, 7, 'Traffic light malfunctioning at Ortigas Avenue, Pasig', 'The traffic signal at Ortigas Avenue, Pasig is stuck on red in all directions, causing confusion among drivers.', 0, 2, 4, 'Verified', 'Confirmed by field officer.', 8, '2026-07-28 10:36:00', '2026-07-28 07:40:00'),
(32, 4, 8, 106, 7, 'Signal timing issue at Ortigas Avenue, Pasig', 'The traffic light cycle at Ortigas Avenue, Pasig seems off, giving very short green light windows and backing up traffic.', 5, 4, 5, 'Pending', NULL, NULL, NULL, '2026-07-26 23:22:00'),
(33, 12, 8, 106, 7, 'Blinking traffic light at Ortigas Avenue, Pasig', 'The signal light at Ortigas Avenue, Pasig is stuck on blinking yellow, so treat it as a four-way stop for now.', 5, 4, 1, 'Verified', 'Confirmed by field officer.', 8, '2026-07-28 13:45:00', '2026-07-28 10:18:00'),
(34, 3, 8, 106, 7, 'Traffic light malfunctioning at Ortigas Avenue, Pasig', 'The traffic signal at Ortigas Avenue, Pasig is stuck on red in all directions, causing confusion among drivers.', 4, 2, 0, 'Rejected', 'Insufficient evidence / duplicate report.', 8, '2026-07-28 14:22:00', '2026-07-28 12:11:00');

/*
5. MEDIA_ATTACHMENTS
*/
INSERT INTO media_attachments (report_id, file_url, file_type) VALUES
-- Taft Avenue Flooding (Reports 5-7)
...
(6, 'assets/report_media/floodtaft1.jpg', 'photo'),
(7, 'assets/report_media/floodtaft2.jpg', 'photo'),

-- Alabang SLEX Traffic (Reports 8-11)
(8, 'assets/report_media/alabangslex1.jpg', 'photo'),
(8, 'assets/report_media/alabangslex2.jpg', 'photo'),
(9, 'assets/report_media/alabangslex3.jpg', 'photo'),
(10, 'assets/report_media/alabangslex4.jpg', 'photo'),
(11, 'assets/report_media/alabangslex5.jpg', 'photo'),

-- Ortigas Avenue Accidents (Reports 12-15)
(12, 'assets/report_media/ortigasaccident1.jpg', 'photo'),
(13, 'assets/report_media/ortigasaccident2.jpg', 'photo'),
(14, 'assets/report_media/ortigasaccident3.jpg', 'photo'),
(15, 'assets/report_media/ortigasaccident4.jpg', 'photo'),

-- Katipunan Avenue Obstructions (Reports 16-18)
(16, 'assets/report_media/katipunanblock1.jpg', 'photo'),
(17, 'assets/report_media/katipunanblock2.jpg', 'photo'),
(18, 'assets/report_media/katipunanblock3.jpg', 'photo'),

-- Marikina Construction (Reports 19-22)
(19, 'assets/report_media/constructionmarikina1.jpg', 'photo'),
(20, 'assets/report_media/constructionmarikina2.jpg', 'photo'),
(21, 'assets/report_media/constructionmarikina3.jpg', 'photo'),
(22, 'assets/report_media/constructionmarikina4.jpg', 'photo'),

-- Quiapo Stalled Vehicles (Reports 23-26)
(23, 'assets/report_media/quiapotraffic1.jpg', 'photo'),
(24, 'assets/report_media/quiapotraffic2.jpg', 'photo'),
(25, 'assets/report_media/quiapotraffic3.jpg', 'photo'),
(26, 'assets/report_media/quiapotraffic4.jpg', 'photo'),

-- Taft Avenue Transit Issues (Reports 27-30)
(27, 'assets/report_media/tafttransit1.jpg', 'photo'),
(28, 'assets/report_media/tafttransit2.jpg', 'photo'),
(29, 'assets/report_media/tafttransit3.jpg', 'photo'),
(30, 'assets/report_media/tafttransit4.jpg', 'photo'),

-- Ortigas Traffic Lights (Reports 31-34)
(31, 'assets/report_media/ortigaslight1.jpg', 'photo'),
(32, 'assets/report_media/ortigaslight2.jpg', 'photo'),
(33, 'assets/report_media/ortigaslight3.webp', 'photo'),
(34, 'assets/report_media/ortigaslight4.jpg', 'photo');
...
(8, 106, 'Lane Closure Along Ortigas Avenue', 'One lane along Ortigas Avenue near the Meralco intersection will be closed for traffic light repairs until further notice. Please use alternate routes during peak hours.', '2026-07-28 08:00:00'),
(2, 167, 'Marikina Riverbanks Road Narrowed for Construction', 'The riverbanks road is temporarily narrowed to a single lane due to ongoing reinforcement work. Motorists are advised to allot extra travel time.', '2026-07-22 09:00:00'),
