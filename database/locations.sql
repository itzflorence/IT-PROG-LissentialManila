-- Manila (administrative districts: historic hearts, u-belt, shipping ports)
...
('Las Piñas', 'Talon Uno'),
('Las Piñas', 'Talon Dos'),
('Las Piñas', 'Talon Tres'),
('Las Piñas', 'Almanza Uno'),
('Las Piñas', 'Almanza Dos'),
('Las Piñas', 'Manuyo Dos'),
('Las Piñas', 'Pilar Village'),
...
('Navotas', 'San Jose'),
('Navotas', 'San Roque'),
('Navotas', 'Tangos North'),
('Navotas', 'Tangos South'),
('Navotas', 'Tanza 1'),
('Navotas', 'Tanza 2');
...
('Parañaque', 'BF Homes'),
('Parañaque', 'Moonwalk'),
('Parañaque', 'San Antonio'),
('Parañaque', 'San Isidro'),
('Parañaque', 'San Dionisio'),
('Parañaque', 'Don Bosco'),
